...
function Home({ changeTheme, theme }) {
  const { data, error } = useSWR('https://raw.githubusercontent.com/serkanalgl/subnetlist/main/subnet-list.json', fetcher)
  ...
  const addNetwork = () => {
    window.open('https://github.com/serkanalgl/subnetlist', '_blank')
  }
        ...
        <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              <Typography variant='h1' className={ classes.chainListSpacing }><span className={ classes.helpingUnderline }>Subnetlist</span></Typography>
              <Typography variant='h2' className={ classes.helpingParagraph }>Helping users connect to Avalanche Subnets</Typography>
              <Typography className={classes.subTitle}>Subnetlist is a list of Avalanche Subnets. Users can use the information to connect their wallets and Web3 middleware providers to the appropriate Chain ID and Network ID to connect to the correct chain.</Typography>
              <Button
                size='large'
                color='primary'
                variant='contained'
